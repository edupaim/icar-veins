...
#include <veins_inet/modules/application/icarnew/RemoteAgentCommInfo.h>
...
std::string RemoteAgentCommInfo::infoTrace(bool header=false, std::string idagent=""){
    std::ostringstream ost;
     ost << CommInfo::infoTrace(header, idagent);
        //<< this->getRemoteAgentCommPerformance()->infoTrace(header, idagent);
